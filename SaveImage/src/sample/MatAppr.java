...
public class MatAppr {
    ...
    public void approximate() {
        ...
        while (count > 0) {
            ...
            if (minVert.value < minHor.value) {
                ...
                if (data[tmp.coord2][coordinate] == 10000 && data[tmp.coord1][coordinate] != 10000) {
                    for (int i = 1; i <= 10 && tmp.coord1 + i < tmp.coord2; i++) {
                        data[tmp.coord1 + i][coordinate] = data[tmp.coord1][coordinate];
                    }
                } else if (data[tmp.coord2][coordinate] != 10000 && data[tmp.coord1][coordinate] == 10000) {
                    for (int i = 10; i > 0 && tmp.coord2 - i > tmp.coord1; i--) {
                        data[tmp.coord2 - i][coordinate] = data[tmp.coord2][coordinate];
                    }
                } else {
                ...
                if (data[coordinate][tmp.coord2] == 10000 && data[coordinate][tmp.coord1] != 10000) {
                    for (int i = 1; i <= 10 && tmp.coord1 + i < tmp.coord2; i++) {
                        data[coordinate][tmp.coord1 + i] = data[coordinate][tmp.coord1];
                    }
                } else if (data[coordinate][tmp.coord2] != 10000 && data[coordinate][tmp.coord1] == 10000) {
                    for (int i = 10; i > 0 && tmp.coord2 - i > tmp.coord1; i--) {
                        data[coordinate][tmp.coord2 - i] = data[coordinate][tmp.coord2];
                    }
                } else {
    ...
    private void makeCloseValues() {
        ...
        if (horizontal.dist == INF && vertical.dist == INF) {
